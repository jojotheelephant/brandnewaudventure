...
const coordinatesLat = 20.931992626697014;
const coordinatesLng = -156.6918592763219;
...
function initialize() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(coordinatesLat, coordinatesLng),
        panControl: true,
        zoomControl: true,
        mapTypeControl: true,
        //scaleControl: false,
    ...
    var marker1 = new MarkerWithLabel({
        position: new google.maps.LatLng(coordinatesLat, coordinatesLng),
        draggable: false,
        raiseOnDrag: false,
        icon: " ",
        map: map,
        labelContent:
            '<div class="de-icon circle small-size" style="background-color:#FFF; border:1px solid #f0394d"><i class="de-icon-heart" style="color:#f0394d;font-size: small;"></i></div>',
        labelAnchor: new google.maps.Point(29, 20),
        labelClass: "labels", // the CSS class for the label
    });

    var marker2 = new MarkerWithLabel({
        position: new google.maps.LatLng(-12.04604, -77.029269),
        draggable: false,
        raiseOnDrag: false,
        icon: " ",
        map: map,
        labelContent:
            '<div class="de-icon circle small-size" style="background-color:#6a6a6a"><i class="de-icon-taxi"></i></div>',
    ...
    //INFO WINDOWS
    //=======================================================================================
    var contentString = "<div>" + "WEDDING CEREMONY";
    ("</div>");

    var contentString1 = "<div>" + "Audrey + Brandon Reception";
    ("</div>");
